# Automated tests to check that the application is working as intended
# reference: https://docs.djangoproject.com/en/3.1/intro/tutorial05/#basic-testing-strategies
