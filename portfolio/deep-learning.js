...
var w = c.width = window.innerWidth,
		...
		opts = {
            ...
            repaintColor: 'rgb(230,230,230)',
            /* color of nodes directly connected to root node */
            connectionColor: 'hsla(200,60%,light%,alp)',
            /* color of root node */
            rootColor: 'hsla(0,60%,light%,alp)',
            /* color of nodes furthest away from root node */
            endColor: 'hsla(160,20%,light%,alp)',
            /* color of the data shooting out of root node */
			dataColor: 'hsla(0,60%,light%,alp)',
